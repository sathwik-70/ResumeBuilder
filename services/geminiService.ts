...
const PROMPTS = {
    ...
    projectDescription: `You are a professional resume writer. Rewrite the following project description to be concise and highlight the impact or technical challenges. Use action verbs and specific terminology where appropriate. The output should be a single paragraph.`,
    skills: `You are a professional resume writer. The user has provided a list of skills (some might be soft skills, some hard skills, potentially unorganized). Rewrite and reorganize them to be a professional, concise list of key competencies and technologies. Remove duplicates and fix spelling. Return the result as a plain list of strings separated by newlines, without categories or bullet points.`
};

export const enhanceWithAI = async (text: string, type: 'summary' | 'bulletPoint' | 'projectDescription' | 'skills'): Promise<string> => {
